...
// NidCorrectionPortal SDK metrics feature
...
class NidCorrectionPortalMetricsFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _record(NidCorrectionPortalContext $ctx, bool $ok): void
    {
