...
// NidCorrectionPortal SDK utility: make_options

class NidCorrectionPortalMakeOptions
{
    ...
    public static function call(NidCorrectionPortalContext $ctx): array
    {
        ...
        //
        // `NidCorrectionPortalSchema::optspec()` is built from the model:
        ...
        $optspec = NidCorrectionPortalSchema::optspec();
