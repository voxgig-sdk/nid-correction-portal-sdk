...
// NidCorrectionPortal SDK timeout feature
...
class NidCorrectionPortalTimeoutFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _with_timeout(NidCorrectionPortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NidCorrectionPortalContext $_ctx, float $ms): void
    {
        $client = $this->client;
