...
// NidCorrectionPortal SDK cache feature
...
class NidCorrectionPortalCacheFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _through(NidCorrectionPortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
