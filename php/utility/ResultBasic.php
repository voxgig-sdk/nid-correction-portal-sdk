...
// NidCorrectionPortal SDK utility: result_basic

class NidCorrectionPortalResultBasic
{
    public static function call(NidCorrectionPortalContext $ctx): ?NidCorrectionPortalResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof NidCorrectionPortalError) ? $result->err->msg : (string)$result->err;
