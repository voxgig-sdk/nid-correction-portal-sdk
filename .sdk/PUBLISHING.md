...
|---|---|---|
| `ts/` | @voxgig-sdk/nid-correction-portal-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nid-correction-portal-sdk \
      --repository voxgig-sdk/nid-correction-portal-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nid-correction-portal-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nid-correction-portal-sdk --id=<id>` removes it.
