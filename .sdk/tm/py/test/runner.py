...
class NidCorrectionPortalTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NidCorrectionPortalTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NidCorrectionPortalTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NidCorrectionPortalTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
