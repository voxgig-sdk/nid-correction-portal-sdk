    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set NIDCORRECTIONPORTAL_TEST_AUTHENTICATION_ENTID JSON to run live")
        client = setup["client"]
...
def _authentication_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "NIDCORRECTIONPORTAL_TEST_AUTHENTICATION_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("NIDCORRECTIONPORTAL_TEST_AUTHENTICATION_ENTID"))
