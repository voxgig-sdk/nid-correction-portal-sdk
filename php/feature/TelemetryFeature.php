...
// NidCorrectionPortal SDK telemetry feature
...
class NidCorrectionPortalTelemetryFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _close(NidCorrectionPortalContext $ctx, bool $ok): void
    {
