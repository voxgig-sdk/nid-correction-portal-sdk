...
// NidCorrectionPortal SDK utility type

class NidCorrectionPortalUtility
{
    ...
    public static function copy(NidCorrectionPortalUtility $src): NidCorrectionPortalUtility
    {
        $u = new NidCorrectionPortalUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
