...
The Golang SDK for the NidCorrectionPortal API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/nid-correction-portal-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/nid-correction-portal-sdk=../path/to/github.com/voxgig-sdk/nid-correction-portal-sdk
```
...
```
github.com/voxgig-sdk/nid-correction-portal-sdk/
...
The root package (`github.com/voxgig-sdk/nid-correction-portal-sdk`) re-exports everything needed
