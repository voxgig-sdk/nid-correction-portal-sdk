...
local CorrectionRequestEntity = {}
CorrectionRequestEntity.__index = CorrectionRequestEntity


function CorrectionRequestEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CorrectionRequestEntity)
  self._name = "correction_request"
  self._client = client
...
function CorrectionRequestEntity:get_name()
  return self._name
end


function CorrectionRequestEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CorrectionRequestEntity.new(self._client, opts)
end
...
function CorrectionRequestEntity:mark_deleted()
  self._deleted = true
end


function CorrectionRequestEntity:deleted()
  return true == self._deleted
end


function CorrectionRequestEntity:data_set(args)
  if args ~= nil then
...
function CorrectionRequestEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CorrectionRequestEntity:match_set(args)
  if args ~= nil then
...
function CorrectionRequestEntity:match_get()
...
function CorrectionRequestEntity:stream(action, args, callopts)
...
---@param reqmatch CorrectionRequestLoadMatch
---@param ctrl? table
---@return CorrectionRequest
---@return string? err
function CorrectionRequestEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CorrectionRequestListMatch
---@param ctrl? table
---@return CorrectionRequest[]
---@return string? err
function CorrectionRequestEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function CorrectionRequestEntity:_run_op(ctx, post_done)
  local utility = self._utility
