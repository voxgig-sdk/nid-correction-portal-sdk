...
module NidCorrectionPortalTestRunner
  ...
  def self.env_override(m)
    live = getenv("NIDCORRECTIONPORTAL_TEST_LIVE")
    override = getenv("NIDCORRECTIONPORTAL_TEST_OVERRIDE")
    ...
    explain = getenv("NIDCORRECTIONPORTAL_TEST_EXPLAIN")
    m["NIDCORRECTIONPORTAL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
