# NidCorrectionPortal SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # NidCorrectionPortalSDK.new, not NidCorrectionPortalSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    NidCorrectionPortalSDK.new(opts)
  end
