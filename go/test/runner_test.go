...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("NIDCORRECTIONPORTAL_TEST_LIVE") == "TRUE" ||
		os.Getenv("NIDCORRECTIONPORTAL_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("NIDCORRECTIONPORTAL_TEST_EXPLAIN"); explain != "" {
