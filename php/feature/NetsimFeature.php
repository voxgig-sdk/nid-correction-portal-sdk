...
// NidCorrectionPortal SDK netsim feature
...
class NidCorrectionPortalNetsimFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _simulate(NidCorrectionPortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NidCorrectionPortalContext $ctx, array $applied): void
    {
        $client = $this->client;
