...
#      offline in seeded test mode (NidCorrectionPortalSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NidCorrectionPortal_sdk.rb")
  SDK_CLASS = "NidCorrectionPortalSDK"
  ...
  SDK_BASE = "NidCorrectionPortal_sdk"
