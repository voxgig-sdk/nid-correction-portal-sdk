...
func registerSDKWords(r *eng.Registry, client *sdk.NidCorrectionPortalSDK) {
...
func runOp(client *sdk.NidCorrectionPortalSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
