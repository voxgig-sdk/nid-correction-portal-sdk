...
from nidcorrectionportal_sdk.utility import register

# Load features
from nidcorrectionportal_sdk.feature.base_feature import NidCorrectionPortalBaseFeature
from nidcorrectionportal_sdk.features import _has_feature, _make_feature
...
class NidCorrectionPortalSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = NidCorrectionPortalUtility()
    ...
    def get_utility(self):
        return NidCorrectionPortalUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NidCorrectionPortalSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Application(self, data=None) -> "ApplicationEntity":
        ...
        from nidcorrectionportal_sdk.entity.application_entity import ApplicationEntity
    ...
    def Authentication(self, data=None) -> "AuthenticationEntity":
        ...
        from nidcorrectionportal_sdk.entity.authentication_entity import AuthenticationEntity
    ...
    def CorrectionRequest(self, data=None) -> "CorrectionRequestEntity":
        ...
        from nidcorrectionportal_sdk.entity.correction_request_entity import CorrectionRequestEntity
