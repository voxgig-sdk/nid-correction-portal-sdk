...
// NidCorrectionPortal SDK rbac feature
...
class NidCorrectionPortalRbacFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _required(NidCorrectionPortalContext $ctx): ?string
    {
    ...
    private function _reject(NidCorrectionPortalContext $ctx, string $required): void
    {
    ...
    private function _track(NidCorrectionPortalContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
