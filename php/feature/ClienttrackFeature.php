...
// NidCorrectionPortal SDK clienttrack feature
...
class NidCorrectionPortalClienttrackFeature extends NidCorrectionPortalBaseFeature
{
    ...
    public function PostConstruct(NidCorrectionPortalContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NidCorrectionPortal-SDK';
