...
// NidCorrectionPortal SDK paging feature
...
class NidCorrectionPortalPagingFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _is_list(NidCorrectionPortalContext $ctx): bool
    {
