...
// instead of `sdk.NewNidCorrectionPortalSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *NidCorrectionPortalSDK  { return NewNidCorrectionPortalSDK(nil) }
func Test() *NidCorrectionPortalSDK { return TestSDK(nil, nil) }
