# NidCorrectionPortal SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NidCorrectionPortalSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NidCorrectionPortalSDK(...) and NidCorrectionPortalSDK.test(...) become
#      NidCorrectionPortalSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nidcorrectionportal_sdk"
_SDK_CLASS = "NidCorrectionPortalSDK"
