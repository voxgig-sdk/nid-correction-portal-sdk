...
local SDK_MODULE = "nid-correction-portal_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["application"] = { ["test01"] = { id = "test01" } }, ["authentication"] = { ["test01"] = { id = "test01" } }, ["correction_request"] = { ["test01"] = { id = "test01" } } } }'
