...
function runner.env_override(m)
  local live = runner.getenv("NID_CORRECTION_PORTAL_TEST_LIVE")
  local override = runner.getenv("NID_CORRECTION_PORTAL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NID_CORRECTION_PORTAL_TEST_EXPLAIN")
