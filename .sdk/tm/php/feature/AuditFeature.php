...
// NidCorrectionPortal SDK audit feature
...
class NidCorrectionPortalAuditFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _emit(NidCorrectionPortalContext $ctx, string $outcome): void
    {
