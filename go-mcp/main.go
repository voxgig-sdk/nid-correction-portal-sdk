// Command NidCorrectionPortal-mcp is an MCP server exposing the NidCorrectionPortal
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NidCorrectionPortal_list  — list records of an entity
//	NidCorrectionPortal_load  — load a single record of an entity
//
