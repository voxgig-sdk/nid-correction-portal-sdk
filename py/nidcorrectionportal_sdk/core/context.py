...
from nidcorrectionportal_sdk.core.helpers import get_ctx_prop, to_map
...
class NidCorrectionPortalContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = NidCorrectionPortalControl()
        ...
        if isinstance(sp, NidCorrectionPortalSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NidCorrectionPortalResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NidCorrectionPortalResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return NidCorrectionPortalOperation({})
    ...
    def make_error(self, code, msg):
        return NidCorrectionPortalError(code, msg, self)
