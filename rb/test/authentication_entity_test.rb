...
class AuthenticationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set NIDCORRECTIONPORTAL_TEST_AUTHENTICATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def authentication_basic_setup(extra)
  ...
  entid_env_raw = ENV["NIDCORRECTIONPORTAL_TEST_AUTHENTICATION_ENTID"]
