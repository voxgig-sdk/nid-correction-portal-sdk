...
AQL-driven CLI and REPL for the NidCorrectionPortal SDK. Positional arguments are
...
```sh
go build -o nid-correction-portal-cli ./...
```
...
./nid-correction-portal-cli list application
./nid-correction-portal-cli load 1 application
./nid-correction-portal-cli load '{id:1}' application
