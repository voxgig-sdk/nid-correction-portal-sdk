...
// NidCorrectionPortal SDK utility: graphql
//
...
class NidCorrectionPortalGraphql
{
    ...
    // equivalent.
    public static function body(NidCorrectionPortalContext $ctx): mixed
    {
    ...
    public static function errors(NidCorrectionPortalContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
