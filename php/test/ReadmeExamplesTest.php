...
// NidCorrectionPortal SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NidCorrectionPortalSDK::test)
...
{
    private const SDK_CLASS = 'NidCorrectionPortalSDK';
    ...
    private const SDK_BASE = 'nidcorrectionportal_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../nidcorrectionportal_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
