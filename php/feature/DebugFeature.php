...
// NidCorrectionPortal SDK debug feature
...
class NidCorrectionPortalDebugFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _finish(NidCorrectionPortalContext $ctx, bool $ok): void
    {
