...
module NidCorrectionPortalTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("NID_CORRECTION_PORTAL_TEST_LIVE")
    override = getenv("NID_CORRECTION_PORTAL_TEST_OVERRIDE")
    ...
    explain = getenv("NID_CORRECTION_PORTAL_TEST_EXPLAIN")
    m["NID_CORRECTION_PORTAL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = NidCorrectionPortalTestRunner
Helpers = NidCorrectionPortalHelpers
Vs = VoxgigStruct
