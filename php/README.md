# NidCorrectionPortal PHP SDK

The PHP SDK for the NidCorrectionPortal API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Application(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->NidCorrectionPortal(null)->load(
    ["id" => "test01"], null
);
...
The main class (`nidcorrectionportal_sdk.php`) exports the SDK class
