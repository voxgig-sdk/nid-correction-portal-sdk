...
type Args struct {
	Entity string         `json:"entity" jsonschema:"application | authentication | correction_request"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NidCorrectionPortalSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "nid-correction-portal_list",
		Description: "List records from NidCorrectionPortal. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "nid-correction-portal_load",
		Description: "Load a single record from NidCorrectionPortal. " +
...
func runOp(client *sdk.NidCorrectionPortalSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NidCorrectionPortalSDK, name string) (sdk.NidCorrectionPortalEntity, error) {
	...
	case "correction_request":
		return client.CorrectionRequest(nil), nil
