...
// NidCorrectionPortal SDK streaming feature
...
class NidCorrectionPortalStreamingFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _iterate(NidCorrectionPortalResult $result): \Generator
    {
    ...
    private function _streamable(NidCorrectionPortalContext $ctx): bool
    {
