...
// NidCorrectionPortal SDK utility: fetcher

class NidCorrectionPortalFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NidCorrectionPortalSDK/1.0)';
    ...
    public static function call(NidCorrectionPortalContext $ctx, string $fullurl, array $fetchdef): array
    {
