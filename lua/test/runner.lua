...
function runner.env_override(m)
  local live = runner.getenv("NIDCORRECTIONPORTAL_TEST_LIVE")
  local override = runner.getenv("NIDCORRECTIONPORTAL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NIDCORRECTIONPORTAL_TEST_EXPLAIN")
