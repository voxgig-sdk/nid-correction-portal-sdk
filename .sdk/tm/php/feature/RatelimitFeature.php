...
// NidCorrectionPortal SDK ratelimit feature
...
class NidCorrectionPortalRatelimitFeature extends NidCorrectionPortalBaseFeature
{
    ...
    private function _acquire(NidCorrectionPortalContext $ctx): void
    {
    ...
    private function _track(NidCorrectionPortalContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
