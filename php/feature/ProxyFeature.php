...
// NidCorrectionPortal SDK proxy feature
...
class NidCorrectionPortalProxyFeature extends NidCorrectionPortalBaseFeature
{
    ...
    public function init(NidCorrectionPortalContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NidCorrectionPortalContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
