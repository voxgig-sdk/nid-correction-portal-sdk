...
const testSeed = `map[string]any{"entity": map[string]any{"application": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "authentication": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "correction_request": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
